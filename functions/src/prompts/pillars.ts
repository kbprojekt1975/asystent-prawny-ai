...
2. **Stosunki Wewnętrzne i Uchwały**:
   - Rozróżniaj powództwo o uchylenie uchwały (sprzeczność z umową spółki/dobrymi obyczajami, godzenie w interes spółki) od powództwo o stwierdzenie nieważności uchwały (sprzeczność z ustawą).
...
## RIGOR DE LA RESPUESTA:
- **Principio de Actualidad**: Añade siempre una advertencia: "Las regulaciones fiscales en Polonia están sujeta a cambios frecuentes (p. ej., el Trato Polaco). Comprueba las tasas actuales para tu forma de tributación antes de tomar una decisión".
