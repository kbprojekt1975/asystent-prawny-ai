...
| `npm run seed`            | **Ważne:** Wgrywa aktualny cennik i prompty do lokalnego emulatora Firestore.                                           |
| `npm run seed:prod`       | **Ważne:** Wgrywa aktualny cennik i prompty na produkcyjną bazę Firestore. (Wymaga zalogowania przez `firebase login`). |
